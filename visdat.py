...
df_hdi = pd.read_csv('dataset.csv')
...
# Mengatur Figure
fig_garis = figure(title='Membandingkan Human Development Index (HDI) Antara 2 Negara',
...
# Membuat Figure
fig_titik = figure(title='Membandingkan Human Development Index (HDI) Antara 2 Negara',
                   plot_height=550, plot_width=1000,
                   x_axis_label='Tahun', y_axis_label='HDI',
                   tools=select_tools)
